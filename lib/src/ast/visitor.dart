...
class GeneralizingAstVisitor<R> implements AstVisitor<R> {
  ...
  @override
  R? visitProgram(Program node) => visitNode(node);
...
class SimpleAstVisitor<R> implements AstVisitor<R> {
  ...
  @override
  R? visitProgram(Program node) => null;
...
class ThrowingAstVisitor<R> implements AstVisitor<R> {
  ...
  @override
  R? visitProgram(Program node) => _throw(node);
...
class TimedAstVisitor<T> implements AstVisitor<T> {
  ...
  T? visitProgram(Program node) {
    stopwatch.start();
    T? result = _baseVisitor.visitProgram(node);
    stopwatch.stop();
    return result;
  }
