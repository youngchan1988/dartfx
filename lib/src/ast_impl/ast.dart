...
import 'package:dartfx/src/ast/precedence.dart';
...
import 'package:dartfx/src/lexer/tokens/token_utils.dart' as util;
...
abstract class AnnotatedNodeImpl extends AstNodeImpl implements AnnotatedNode {
  ...
  Token get beginToken {
    ...
    if (commentToken.charOffset < metadataToken.charOffset) {
      return commentToken;
    }
...
class EphemeralIdentifier extends SimpleIdentifierImpl {
  EphemeralIdentifier(AstNode parent, int location)
      : super(StringToken(
            type: TokenType.IDENTIFIER, value: "", offset: location)) {
...
class MethodDeclarationImpl extends ClassMemberImpl
  ...
  @override
  Token get firstTokenAfterCommentAndMetadata {
    return Token.lexicallyFirst(externalKeyword) ??
        _returnType?.beginToken ??
...
class ProgramImpl extends AstNodeImpl implements Program {
  ProgramImpl(this.beginToken, this.endToken, this.expression);

  @override
  Token beginToken;

  @override
  E? accept<E>(AstVisitor<E> visitor) => visitor.visitProgram(this);

  @override
  Iterable<SyntacticEntity> get childEntities =>
      ChildEntities()..add(expression);
...
class VariableDeclarationListImpl extends AnnotatedNodeImpl
  ...
  @override
  Token get firstTokenAfterCommentAndMetadata {
    return Token.lexicallyFirst(keyword) ??
        _type?.beginToken ??
